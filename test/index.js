...
parallel('::launch / if the opts.bail is true, it should be to stop the serial execution in exit 1', () => {
  const emitter = new AsyncEmitter;
  const launch = new Launch(emitter);
